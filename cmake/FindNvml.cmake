# Version 1.2 Public Domain Written by Maxime SCHMITT
# <maxime.schmitt@etu.unistra.fr>

# /////////////////////////////////////////////////////////////////////////////#
# # Search for Nvidia nvml library on the system # Call with find_package(NVML)
# # The module defines: # - NVML_FOUND        - If NVML was found # -
...
file(
  GLOB
  nvml_header_path_hint
  /usr/include/nvidia*/include
...
if(EXISTS ${filename})
  ...
  string(
    REGEX
    REPLACE ".*#[ \t]*define[ \t]*${nvml_api_version_match}[ \t]*([0-9]+).*"
